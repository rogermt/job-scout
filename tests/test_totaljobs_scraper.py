...
class TestBuildSearchUrl:
    ...
    def test_build_search_url_special_characters(self, scraper: TotaljobsScraper) -> None:
...
class TestOtherMethods:
    ...
    def test_calculate_posted_date_with_valid_days_ago(self, scraper: TotaljobsScraper) -> None:
...
class TestGetJobDetails:
    ...
    def test_get_job_details_delegates(self, scraper: TotaljobsScraper) -> None:
        ...
        with patch.object(scraper, 'scrape_job_details', return_value="Test description"):
